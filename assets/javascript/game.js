// Array of animals
var topics = ["dog", "cat", "lion", "horse", "pig",
                  "giraffe", "sheep", "hamster", "wolf", "bear",
                  "cow", "elephant", "zebra", "rabbit", "alligator",
                  "whale", "kangaroo", "deer", "otter", "parrot", "peacock"];
...
$("#add-animal").on("click", function(event) {
  ...
  // The animal from the textbox is then added to the topics array
...
// AnimalGifs will obtain animal Gifs with the Giphy API
function AnimalGifs() {
